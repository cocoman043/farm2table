function TransactionCard({ name, price, quantity }) {
  const total = price * quantity;

  return (
    <>
      <div className="card card-side bg-white shadow-xl max-w-96 min-w-96 drop-shadow">
        <figure className="w-1/2"><img className="object-cover h-full" src="/food_placeholder.png" alt="transaction-image" /></figure>
